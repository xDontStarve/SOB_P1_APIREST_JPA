    ...
    <body>
        ...
        <%
            ...
            String data[] = new String[]{
                ...
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'Location', 'GB', 'desc', 'HORROR', 1, 'house', 12.5, 7)",
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'Location', 'NDS', 'desc', 'FAMILY', 0, 'justdance', 6.99, 0)",
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'Location', 'PS1', 'desc', 'ADVENTURE', 1, 'palworld', 19.99, 4)",
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'Location', 'PS2', 'desc', 'SHOOTER', 1, 'valo', 0.00, 990)",
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'Location', 'PS4', 'desc', 'RACING', 1, 'mariokart', 59.99, 2)",
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'Location', 'PS3', 'desc', 'ACTION', 1, 'resident', 990.2, 3)",
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'Location', 'PS2', 'desc', 'FAMILY', 1, 'wiiu', 5.00, 10)",
