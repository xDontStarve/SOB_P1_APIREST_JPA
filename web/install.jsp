    ...
    <body>
        ...
        <%
            ...
            String data[] = new String[]{
                ...
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'CARRER FLORECILLAS', 'PS1', 'SCARIEST GAME EVER', 'HORROR', 0, 'BIKINI TSUNAMI', 69.99, 1)",
                ...
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'EN MI MENTE', 'GB', 'DONDE VAS CUANDO ESTAS EN UN EXAMEN', 'RACING', 1, 'LA ULTIMA NEURONA', 0.00, 1)",
