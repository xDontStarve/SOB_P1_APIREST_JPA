    ...
    <body>
        ...
        <%
            ...
            String data[] = new String[]{
                ...
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'C/ 1, as cool', 'GB', 'desc', 'HORROR', 1, 'house', 12.5, 7)",
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'tarragona, paseo prim', 'NDS', 'desc', 'FAMILY', 0, 'justdance', 6.99, 0)",
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'Calle La salle, 3. Carrer Prim, 58, Reus', 'PS1', 'desc', 'ADVENTURE', 1, 'palworld', 19.99, 4)",
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'Centro Madrid, Centro BCN', 'PS2', 'desc', 'SHOOTER', 1, 'valo', 0.00, 990)",
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'C/ General II, Malaga. Paseo principal, 5, Sevilla', 'PS4', 'desc', 'RACING', 1, 'mariokart', 59.99, 2)",
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'Centro Comercial, C/ Ovigo, Girona', 'PS3', 'desc', 'ACTION', 1, 'resident', 990.2, 3)",
                "INSERT INTO " + schema + ".GAME (ID, ADDRESS, CONSOLE, DESCRIPTION, GENRE, ISAVAILABLE, NAME, PRICE, UNITS) VALUES (NEXT VALUE FOR GAME_GEN, 'Calle pedrosa, 2, Vigo', 'PS2', 'desc', 'FAMILY', 1, 'wiiu', 5.00, 10)",
